...
- Learn how to [configure agents](/docs/core-concepts/agent-configuration) in detail
- Learn more about [Crew Configuration](/docs/core-concepts/crew-configuration)
- Integrate [MCP Servers](/docs/advanced-features/mcp-integration)
- Explore [creating custom functions](/docs/core-concepts/creating-functions) to enhance your agents
- See how to manage [state across agents](/docs/core-concepts/state-management) in a crew
