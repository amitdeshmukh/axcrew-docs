  ...
  "crew": [
    {
      ...
      "ai": { "model": "gpt-3.5-turbo", "temperature": 0 }
    },
    {
      "name": "Planner",
    ...
    },
    {
      ...
      "ai": { "model": "claude-3-sonnet", "temperature": 0.2 },
...
// User query
const userQuery = "What's the square root of the number of days until Christmas?";
...
console.log(`Plan: ${planResponse.plan}`);
console.log(`Answer: ${managerResponse.answer}`);
```

## Tracking Crew Costs

The AxCrew system provides detailed cost tracking:
